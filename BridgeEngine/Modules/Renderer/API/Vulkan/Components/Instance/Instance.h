...
public:
	// The VulkanInstance will hold the resources created by the various handlers 	
	...
	VulkanInstance(VulkanContext* vulkanContext) {
		this->m_vulkan_context = vulkanContext;
	}
	...
	VulkanContext* m_vulkan_context = 0;
