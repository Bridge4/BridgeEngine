...
void VulkanContext::CreateGraphicsPipeline() {
    std::vector<char> vertShaderCode = readFile("F:/FDev/EngineProjects/EngineProjectTemplate/ProjectTemplate/Core/Source/Renderer/Shaders/vert.spv");
    std::vector<char> fragShaderCode = readFile("F:/FDev/EngineProjects/EngineProjectTemplate/ProjectTemplate/Core/Source/Renderer/Shaders/frag.spv");
